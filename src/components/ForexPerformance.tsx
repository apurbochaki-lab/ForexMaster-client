...
export default function ForexPerformance() {
    ...
    const bars = [
        { label: 'EURUSD', code: 'EU', val: '35.2%', width: 'w-[85%]', isHighlight: true, bg: 'bg-blue-500/20' },
        { label: 'GBPUSD', code: 'GU', val: '22.1%', width: 'w-[65%]', isHighlight: false, bg: 'bg-red-500/20' },
        { label: 'GOLD', code: 'XU', val: '15.8%', width: 'w-[45%]', isHighlight: false, bg: 'bg-yellow-500/20' },
        { label: 'USDJPY', code: 'UJ', val: '12.5%', width: 'w-[30%]', isHighlight: false, bg: 'bg-purple-500/20' },
        { label: 'BTCUSD', code: 'BTC', val: '8.4%', width: 'w-[15%]', isHighlight: false, bg: 'bg-orange-500/20' },
    ];
        ...
        <main className="flex-grow pt-32 pb-12 px-6 relative z-10 bg-[#0b1326] text-[#dae2fd] min-h-screen font-sans overflow-x-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-12">
                    ...
                    {/* Left: Line Chart */}
                    <div className="bg-slate-800/40 backdrop-blur-xl border border-white/10 rounded-2xl p-5 flex flex-col min-h-[400px]">
                        ...
                        >
                            ...
                            <div className="absolute left-9 right-0 top-0 bottom-8 z-20">
                                <svg className="w-full h-full drop-shadow-[0_0_8px_rgba(16,185,129,0.5)]" preserveAspectRatio="none" viewBox="0 0 100 100">
                                    <path d="M0,60 Q10,40 20,50 T40,30 T60,45 T80,20 T100,25" fill="none" stroke="#10b981" strokeWidth="2" vectorEffect="non-scaling-stroke"></path>
                                    <circle className="animate-pulse" cx="40" cy="30" fill="#10b981" r="3"></circle>
                                    <circle className="animate-pulse" cx="80" cy="20" fill="#10b981" r="3"></circle>
                                    <circle cx="100" cy="25" fill="#10b981" r="4" stroke="#0b1326" strokeWidth="2"></circle>
                                </svg>
                                <div className="absolute right-2 top-4 bg-[#4edea3] text-[#003824] font-mono text-[10px] px-2 py-0.5 rounded shadow-lg font-bold">
                                    95.2%
                                </div>
                            </div>
                        </div>
                            ...
                            {bars.map((bar, i) => (
                                <div key={i} className="flex items-center gap-4">
                                    ...
                                    <div className="flex-grow h-2 bg-zinc-800 rounded-full overflow-hidden relative">
                                        <div className={`absolute top-0 left-0 h-full ${bar.isHighlight ? 'bg-[#ffb95f] shadow-[0_0_10px_rgba(245,158,11,0.5)]' : 'bg-[#4edea3] opacity-80'} ${bar.width} rounded-full`}></div>
                                    </div>
                ...
                <div className="flex flex-wrap justify-center gap-4 md:gap-6">
                    <div className="bg-slate-800/40 backdrop-blur-xl px-6 py-3 rounded-full flex items-center gap-3 border border-white/10 border-t-[#4edea3]/30">
                    ...
                    <div className="bg-slate-800/40 backdrop-blur-xl px-6 py-3 rounded-full flex items-center gap-3 border border-white/10 border-t-[#ffb95f]/30">
